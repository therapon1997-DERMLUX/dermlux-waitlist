...
/* Animated DermLux monogram — recreated as SVG so it stays crisp,
   draws itself on load and spins as a 3D coin. */
function Emblem() {
  return (
    <div className="dlx-emblem-spin">
      <svg className="dlx-emblem" viewBox="0 0 200 200" fill="none" aria-hidden="true">
        {/* double ring, like the print logo */}
        <circle className="dlx-draw dlx-draw-1" cx="100" cy="100" r="92" stroke="currentColor" strokeWidth="1.6" />
        <circle className="dlx-draw dlx-draw-2" cx="100" cy="100" r="85" stroke="currentColor" strokeWidth="0.8" />
        {/* interlocked double-D motif */}
        <path className="dlx-draw dlx-draw-3" d="M100 52 V148" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path className="dlx-draw dlx-draw-4" d="M100 54 a24 24 0 0 1 0 46 a24 24 0 0 1 0 46" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
        <path className="dlx-draw dlx-draw-5" d="M100 54 a24 24 0 0 0 0 46 a24 24 0 0 0 0 46" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
        <circle cx="100" cy="42" r="2.4" fill="currentColor" />
        <circle cx="100" cy="158" r="2.4" fill="currentColor" />
      </svg>
    </div>
  )
}
  ...
  return (
    <div className="dlx-home" ref={heroRef} onMouseMove={onMouseMove} onMouseLeave={onMouseLeave}>
      ...
      <section className="dlx-hero">
        ...
        <div className="dlx-subtitle">Laser &amp; Medical Aesthetics</div>
