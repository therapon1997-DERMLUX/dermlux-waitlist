const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-CAyT_5xZ.js","assets/Home-BlnFTLGc.css","assets/Dashboard-8ddxn6Ra.js","assets/dateHelpers-Cfb31Rsj.js","assets/AdminPanel-Dcyb5uBB.js","assets/audit-BEgpqflu.js","assets/EmailMarketing-BeqiQR_b.js","assets/BarChart-CGCDhdJ2.js","assets/BallotResults-V8erUxEs.js","assets/xlsx-D_0l8YDs.js","assets/ElectionArchive-CkBPrVCs.js","assets/VoteContacts-R5UjPW-D.js","assets/EklogikáKentra-DY-O2kDH.js","assets/Bookkeeping-4HV1gEOU.js","assets/ExpenseModal-DqIzpktH.js","assets/BankChip-Cz2XLRdJ.js","assets/BankTransactions-cGwcjnNA.js","assets/ExpenseUpload-CikeUDN4.js","assets/ClaudeRemote-BZ2WJRaq.js"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gr=new Am("@firebase/firestore");function ys(){return Gr.logLevel}function CM(t){Gr.setLogLevel(t)}function U(t,...e){if(Gr.logLevel<=ie.DEBUG){const n=e.map(Mm);Gr.debug(`Firestore (${Eo}): ${t}`,...n)}}function ze(t,...e){if(Gr.logLevel<=ie.ERROR){const n=e.map(Mm);Gr.error(`Firestore (${Eo}): ${t}`,...n)}}function en(t,...e){if(Gr.logLevel<=ie.WARN){const n=e.map(Mm);Gr.warn(`Firestore (${Eo}): ${t}`,...n)}}function Mm(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function W(t="Unexpected state"){const e=`FIRESTORE (${Eo}) INTERNAL ASSERTION FAILED: `+t;throw ze(e),new Error(e)}function Q(t,e){t||W()}function kM(t,e){t||W()}function $(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ss{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new B(O.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ae(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}function QM(){return new ss("__name__")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function aF(t){return new ul("sum",cl("sum",t))}function lF(t){return new ul("avg",cl("average",t))}function IL(){return new ul("count")}function uF(t,e){var n,r;return t instanceof ul&&e instanceof ul&&t.aggregateType===e.aggregateType&&((n=t._internalFieldPath)===null||n===void 0?void 0:n.canonicalString())===((r=e._internalFieldPath)===null||r===void 0?void 0:r.canonicalString())}function cF(t,e){return RA(t.query,e.query)&&zr(t.data(),e.data())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function SL(t){t=ne(t,Ge);const e=ne(t.firestore,ge);return IA(Ne(e),t._key).then(n=>Vg(e,t,n))}class ui extends BA{constructor(e){super(),this.firestore=e}convertBytes(e){return new Yi(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Ge(this.firestore,null,n)}}function dF(t){t=ne(t,Ge);const e=ne(t.firestore,ge),n=Ne(e),r=new ui(e);return nL(n,t._key).then(i=>new po(e,r,t._key,i,new ki(i!==null&&i.hasLocalMutations,!0),t.converter))}function fF(t){t=ne(t,Ge);const e=ne(t.firestore,ge);return IA(Ne(e),t._key,{source:"server"}).then(n=>Vg(e,t,n))}function pF(t){t=ne(t,ht);const e=ne(t.firestore,ge),n=Ne(e),r=new ui(e);return LA(t._query),TA(n,t._query).then(i=>new mo(e,r,t,i))}function mF(t){t=ne(t,ht);const e=ne(t.firestore,ge),n=Ne(e),r=new ui(e);return rL(n,t._query).then(i=>new mo(e,r,t,i))}function gF(t){t=ne(t,ht);const e=ne(t.firestore,ge),n=Ne(e),r=new ui(e);return TA(n,t._query,{source:"server"}).then(i=>new mo(e,r,t,i))}function Hw(t,e,n){t=ne(t,Ge);const r=ne(t.firestore,ge),i=Fh(t.converter,e,n);return Ll(r,[Nh(as(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,Re.none())])}function _F(t,e,n,...r){t=ne(t,Ge);const i=ne(t.firestore,ge),s=as(i);let o;return o=typeof(e=ce(e))=="string"||e instanceof ss?xg(s,"updateDoc",t._key,e,n,r):kg(s,"updateDoc",t._key,e),Ll(i,[o.toMutation(t._key,Re.exists(!0))])}function yF(t){return Ll(ne(t.firestore,ge),[new So(t._key,Re.none())])}function vF(t,e){const n=ne(t.firestore,ge),r=Xu(t),i=Fh(t.converter,e);return Ll(n,[Nh(as(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,Re.exists(!1))]).then(()=>r)}function wF(t,...e){var n,r,i;t=ce(t);let s={includeMetadataChanges:!1,source:"default"},o=0;typeof e[o]!="object"||Sp(e[o])||(s=e[o],o++);const a={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(Sp(e[o])){const f=e[o];e[o]=(n=f.next)===null||n===void 0?void 0:n.bind(f),e[o+1]=(r=f.error)===null||r===void 0?void 0:r.bind(f),e[o+2]=(i=f.complete)===null||i===void 0?void 0:i.bind(f)}let u,c,d;if(t instanceof Ge)c=ne(t.firestore,ge),d=Io(t._key.path),u={next:f=>{e[o]&&e[o](Vg(c,t,f))},error:e[o+1],complete:e[o+2]};else{const f=ne(t,ht);c=ne(f.firestore,ge),d=f._query;const m=new ui(c);u={next:v=>{e[o]&&e[o](new mo(c,m,f,v))},error:e[o+1],complete:e[o+2]},LA(t._query)}return function(m,v,S,P){const C=new Ph(P),w=new pg(v,C,S);return m.asyncQueue.enqueueAndForget(async()=>hg(await fo(m),w)),()=>{C.Za(),m.asyncQueue.enqueueAndForget(async()=>dg(await fo(m),w))}}(Ne(c),d,a,u)}function EF(t,e){return sL(Ne(t=ne(t,ge)),Sp(e)?e:{next:e})}function Ll(t,e){return function(r,i){const s=new it;return r.asyncQueue.enqueueAndForget(async()=>DO(await Ig(r),i,s)),s.promise}(Ne(t),e)}function Vg(t,e,n){const r=n.docs.get(e._key),i=new ui(t);return new po(t,i,e._key,r,new ki(n.hasPendingWrites,n.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xF(){return new Dl("deleteField")}function Qw(){return new Ag("serverTimestamp")}function bF(...t){return new Rg("arrayUnion",t)}function NF(...t){return new Pg("arrayRemove",t)}function DF(t){return new Cg("increment",t)}function VF(t){return new xh(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function OF(t){return Ne(t=ne(t,ge)),new VL(t,e=>Ll(t,e))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jF(t){var e;const n=(e=Ne(ne(t.firestore,ge))._onlineComponents)===null||e===void 0?void 0:e.datastore.serializer;return n===void 0?null:Eh(n,Et(t._query))._t}function zF(t,e){var n;const r=z0(e,(s,o)=>new yS(o,s.aggregateType,s._internalFieldPath)),i=(n=Ne(ne(t.firestore,ge))._onlineComponents)===null||n===void 0?void 0:n.datastore.serializer;return i===void 0?null:bS(i,nS(t._query),r,!0).request}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $F{constructor(){throw new Error("instances of this class should not be created")}static onExistenceFilterMismatch(e){return Og.instance.onExistenceFilterMismatch(e)}}class Og{constructor(){this.Uu=new Map}static get instance(){return Au||(Au=new Og,function(n){if(Lc)throw new Error("a TestingHooksSpi instance is already set");Lc=n}(Au)),Au}et(e){this.Uu.forEach(n=>n(e))}onExistenceFilterMismatch(e){const n=Symbol(),r=this.Uu;return r.set(n,e),()=>r.delete(n)}}let Au=null;(function(e,n=!0){(function(i){Eo=i})(ni),qr(new $r("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),a=new ge(new oD(r.getProvider("auth-internal")),new uD(r.getProvider("app-check-internal")),function(c,d){if(!Object.prototype.hasOwnProperty.apply(c.options,["projectId"]))throw new B(O.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new $i(c.options.projectId,d)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),a._setSettings(s),a},"PUBLIC").setMultipleInstances(!0)),cn(Fv,"4.7.3",e),cn(Fv,"4.7.3","esm2017")})();var ML="firebase",FL="10.14.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
